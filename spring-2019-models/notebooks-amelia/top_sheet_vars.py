...
def get_data():
    ...
    for year in [2010, 2015, 2025]:
        persons = hdfstore["/{}/persons".format(year)].sample(2000000)
        hh = hdfstore["/{}/households".format(year)].sample(2000000)
        buildings = hdfstore["/{}/buildings".format(year)].sample(2000000)
        parcels = hdfstore["/{}/parcels".format(year)].sample(2000000)
        jobs = hdfstore["/{}/jobs".format(year)].sample(2000000)
...
accessibilities_by_demog(2025, 10000, net, 'region').sum(axis=0).to_csv("indicators_output/region_10000_2025")
accessibilities_by_demog(2025, 10000, net, 1).sum(axis=0).to_csv("indicators_output/alameda_10000_2025")
accessibilities_by_demog(2025, 10000, net, 41).sum(axis=0).to_csv("indicators_output/marin_10000_2025")
accessibilities_by_demog(2025, 10000, net, 13).sum(axis=0).to_csv("indicators_output/marin_10000_2025")
accessibilities_by_demog(2025, 10000, net, 81).sum(axis=0).to_csv("indicators_output/marin_10000_2025")
accessibilities_by_demog(2025, 10000, net, 85).sum(axis=0).to_csv("indicators_output/marin_10000_2025")
